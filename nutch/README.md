...
```
This project is my Diploma project, based on Apache Nutch 1.15.
The scope of this project is to put together a crawling service,
which will offer parsing and indexing of the crawled content.
